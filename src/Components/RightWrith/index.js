...
import {change_markd, change_ScrollHeightTop, change_GerTextArrays} from './store/actionCreate'
...
let RightWrith = (props) => {
    let {changeMD, changeScrollHeight, GetArrayText } = props;
